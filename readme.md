...
Also predicting color palette and outfit trend analyzer.
...
- **python scripts:** These are 2 Python files responsible for different steps in the pipeline. The order of execution is as follows:
    1. code.py
    2. streamlit.py
